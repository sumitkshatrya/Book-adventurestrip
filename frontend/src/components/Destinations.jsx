...
//       // Get filter parameters for the API call
//       const apiFilters = {};
...
//       const response = await destinationService.getAllDestinations(apiFilters);
...
//             <button className="px-8 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition duration-200 font-semibold">
...
// components/Destinations.jsx - Updated image handling
import { useState, useEffect } from 'react';
import { IndianRupee, MapPin, Star, Filter, X, Search, Clock, Users } from 'lucide-react';
import { Link } from 'react-router-dom';
import { destinationService } from '../services/destinationService';
